...
import cn.asmm.shop.adapter.B1_ProductListAdapter;
import cn.asmm.shop.adapter.GoodListLargeListActivityAdapter;
import cn.asmm.shop.model.GoodsListModel;
import cn.asmm.shop.model.ShoppingCartModel;
import cn.asmm.shop.protocol.ApiInterface;
import cn.asmm.shop.protocol.FILTER;
import cn.asmm.shop.protocol.PAGINATED;
       ...
       final LinearLayout mainView = (LinearLayout) findViewById(R.id.keyboardLayout1);
        ...
        if (null != filter_string)
        {
            try
            {
                ...
                filter =new cn.asmm.shop.protocol.FILTER();
            ...
            case 1:
            {
                if(null != data)
                {
                    ...
                    if (null != filter_string)
                    {
                        ...
                        {
                            JSONObject filterJSONObject = new JSONObject(filter_string);
                            FILTER filter = new cn.asmm.shop.protocol.FILTER();
                            filter.fromJson(filterJSONObject);
