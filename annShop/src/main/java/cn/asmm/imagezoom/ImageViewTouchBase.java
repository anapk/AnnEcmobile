...
import cn.asmm.BeeFramework.view.WebImageView;
import cn.asmm.imagezoom.easing.Cubic;
import cn.asmm.imagezoom.easing.Easing;
import cn.asmm.imagezoom.graphics.FastBitmapDrawable;
import cn.asmm.imagezoom.utils.IDisposable;
...
public abstract class ImageViewTouchBase extends WebImageView implements IDisposable {
	...
	/**
	 * Use this to change the {@link cn.asmm.imagezoom.ImageViewTouchBase#setDisplayType(cn.asmm.imagezoom.ImageViewTouchBase.DisplayType)} of
	 * this View
	 * @author alessandro
	 *
	 */
	 ...
	 * or the {@link cn.asmm.imagezoom.ImageViewTouchBase.DisplayType} has been modified
	 * 
	 * @param left
	 * @param top
	 * @param right
