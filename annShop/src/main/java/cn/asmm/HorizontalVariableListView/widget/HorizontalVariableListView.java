...
package cn.asmm.HorizontalVariableListView.widget;
...
import cn.asmm.HorizontalVariableListView.utils.DataSetObserverExtended;
import cn.asmm.HorizontalVariableListView.utils.ReflectionUtils;
import cn.asmm.HorizontalVariableListView.utils.ReflectionUtils.ReflectionException;
import cn.asmm.HorizontalVariableListView.widget.IFlingRunnable.FlingRunnableView;
...
public class HorizontalVariableListView extends HorizontalListView implements OnGestureListener, FlingRunnableView {
	...
	private synchronized void initView() {
		...
		if ( Build.VERSION.SDK_INT > 8 ) {
			try {
				mFlingRunnable = (IFlingRunnable) ReflectionUtils.newInstance( "cn.asmm.HorizontalVariableListView.widget.Fling9Runnable",
