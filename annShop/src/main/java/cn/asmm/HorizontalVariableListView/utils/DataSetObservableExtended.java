package cn.asmm.HorizontalVariableListView.utils;

import android.database.Observable;

public class DataSetObservableExtended extends Observable<cn.asmm.HorizontalVariableListView.utils.DataSetObserverExtended> {
